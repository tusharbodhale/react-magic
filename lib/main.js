var CodePanel = React.createClass({
          ...
          <div className="panel panel-default lib-panel">
            <div className="panel-body">
              <ul className="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#library4">World</a></li>
              </ul>
              ...
              <div className="tab-content">
                ...
                <div id="library4" className="tab-pane fade">
                  <h3>World</h3>
                  <div className="avatar-icons">
                    <div className="icon">
                      <div className="single-world black"></div>
                      <label>BLACK</label>
                    </div>
                    <div className="icon">
                      <div className="single-world white"></div>
                      <label>WHITE</label>
                    </div>
                    <div className="icon">
                      <div className="single-world red"></div>
                      <label>RED</label>
                    </div>
                    <div className="icon">
                      <div className="single-world green"></div>
                      <label>GREEN</label>
                    </div>
                    <div className="icon">
                      <div className="single-world blue"></div>
                      <label>BLUE</label>
                    </div>
                    <div className="icon">
                      <div className="single-world galaxy"></div>
                      <label>galaxy</label>
                    </div>
                  </div>
                </div>
  ...
  var Main = React.createClass({
    getInitialState: function() {
      ...
      myAvatar.appear(250,150);
      myAvatar2 =new Avatar("sun",100);
      myAvatar2.appear(200,100);
